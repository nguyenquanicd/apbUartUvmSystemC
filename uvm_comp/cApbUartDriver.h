...
{
    public:
        cIfApbUart* uart_IfApbUart; //component
        ...
        void build_phase(uvm::uvm_phase& phase)
        {
            ...
            if(!uvm::uvm_config_db<cIfApbUart*>::get(this,"*","IfApbUart",uart_IfApbUart))
        ...
        void get_seq_and_drive(){
            ...
            while(true){
                ...
                std::cout << sc_time_stamp() <<" convert_seq2apb " << std::endl;
                convert_seq2apb(req);
                sc_core::wait(1, sc_core::SC_NS);
        ...
        void convert_seq2apb(const REQ& user_req){
            if(user_req.apbSeqEn){
              ...
              if(user_req.apbSeqEn == 1){
                 uart_IfApbUart->pwdata.write(user_req.pwdata);
              }
              sc_core::wait(5, sc_core::SC_NS);
              std::cout << sc_time_stamp() << " Ca quan que ne " << uart_IfApbUart->pwdata <<  std::endl;
            } 
            sc_core::wait(1, sc_core::SC_NS);
        }
